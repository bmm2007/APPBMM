...
class ControladorUsuarios{
    ...
    public  static function ctrIngresoUsuario($user, $pass, $token){
        ...
        if(isset($user)){
           if(preg_match('/^[a-zA-Z0-9]+$/', $user)  && preg_match("/^[a-zA-Z0-9]+$/", $pass)){
                ...
                $respuesta =    ModeloUsuarios::mdlMostrarUsuarios($tabla,$item,$valor);
                    ...
                    if($respuesta == true && $respuesta['usuario'] == $user && $respuesta['contrasena'] == $encriptar){
                        ...
                        if($ultimoLogin == 'ok'){
                            ...
                            $('input, button, span,i').fadeOut(500);
                            $('.g-recaptcha div').hide();

                                $('#resultLogin').hide().fadeIn(500).html('<br><img style=\"width:85px\" src=\"vistas/img/reload8.svg\">').delay(1500).fadeOut(500, function(){
                                        window.location = 'sistem';
                                    });                                                        
                                    </script>";
