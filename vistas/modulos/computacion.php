...
<section class="w3l-breadcrumb">
    ...
    <div class="breadcrumb-bg breadcrumb-bg-computacion py-8">
        <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
            <h2 class="title mt-8 pt-lg-5 pt-sm-3"><i class="fas fa-graduation-cap"></i> Computación e Informática</h2>
            <ul class="breadcrumbs-custom-path pb-sm-5 pb-4 mt-2 text-center mb-md-5">
                <li><a href="./">Inicio</a></li>
                <li class="active"> / Computación </li>
            </ul>
        </div>
    </div>
        ...
        <div class="container" id="courses">
            <div class="flex" style="margin-left: 10px; margin-right: 10px;">
                ...
                <p class="text-para first-letra">
                    Nuestra carrera de Computación e Informática evoluciona para
                    convertirse en la carrera de Desarrollo de Sistemas de
                    Información, formando profesionales técnicos con
                    capacidades para desarrollar aplicaciones y sistemas de
                    información en distintas plataformas (escritorio, web o móvil),
                    permitiendo que las tecnología de información y comunicación
                    se convierta en una herramienta que mejora la competitividad
                    de las empresas. Al culminar, podrás convalidar tus estudios
                    con carreras como Ingeniería informática e Ingeniería de
                    Software.
                <p class="text-para">Estudia con los mejores laboratorios y profesores de
                    reconocida trayectoria en uno de los mejores institutos de
                    Computación de la Región San Martín. La Computación estudia
                    todos los procesos con la finalidad de almacenar, procesar y
                    transmitir información mediante cualquier dispositivo móvil o
                ...
                <p class="text-para">
                    Esta sólida carrera te permitirá adoptar una mentalidad más estratégica y
                    perfeccionar tus habilidades de toma de decisiones efectivas; también te ayudará a
                    llevar a tu organización al siguiente nivel.
                <p class="text-para">Durante tus estudios en una combinación
                    de módulos interactivos con tus compañeros que invitan a la reflexión, y que te
                    permitirán explorar estudios de caso contemporáneos, investigaciones destacadas y
                    las mejores prácticas aplicables. Igualmente, descubrirás cómo aplicar los últimos
                    conceptos en gestión del rendimiento y analítica en la gestión de Empresas , para
                    ayudar a que tu organización obtenga una ventaja competitiva en su sector.
                </p>
