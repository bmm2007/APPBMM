...
$tabla = 'noticias ORDER BY id DESC';
$item = null;
$valor = null;
  ...
  <tbody>
    ...
    foreach ($resultado as $key => $value) :
      ...
      echo "<tr id='delete" . $value['id'] . "'>
           ...
           <td>" . $value['titulo'] . "</td> 
           <td style='text-align: center;'><div class='img-ne'><img src='vistas/img/noticias/" . $value['foto'] . "?n=" . $rand . "' width='160px'></img></div></td>  
           ...
           <button class='btn btn-danger btn-lg btn-eliminar' idEliminar='" . $value['id'] . "' tabla='noticias'><i class='far fa-trash-alt'></i></button>
         </td> 
           </tr>";
    endforeach;
