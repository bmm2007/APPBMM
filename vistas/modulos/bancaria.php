...
<div class="banner-compu" id="bannerInscripcion"><img src="vistas/img/administracionbancaria.jpg?q=<?php echo $time; ?>" alt=""></div>
<!-- about breadcrumb -->
<section class="w3l-breadcrumb">

    <div class="breadcrumb-bg breadcrumb-bg-adminbancaria py-8">
