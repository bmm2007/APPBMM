...
<section id="quienes-somos" class="quienes-somos">
    <div id="mision" class="mision" style="width: 400px; height:400px; padding:10px;">
        <h3 class="title-big mb-4">MISION</h3>
        <p>Somos una Institución Superior, que forma profesionales técnicos calificados
    ...
    <div id="vision" class="vision" style="width: 400px; height:400px; padding:10px;">
        <h3 class="title-big mb-4">VISION</h3>
